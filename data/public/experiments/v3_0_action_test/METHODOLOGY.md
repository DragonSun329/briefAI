# Experiment Methodology: v3_0_action_test

> Auto-generated methodology documentation for the **Incentive + action prediction engine** forward-test experiment.

**Generated**: 2026-02-10 08:43:25 UTC  
**Engine Tag**: `ENGINE_v3.0_ACTION`  
...
> Incentive + action prediction engine

### 1.3 Prediction Types

This experiment generates the following prediction types:

- **Action Events**: Predictions about specific company actions (e.g., partnership announcements, pricing changes, product launches)
...
### 4.3 Action Event Predictions

Action event predictions forecast specific company behaviors.

**Event Types**:

- **Partnership Announcement**: Strategic partnership, integration deal, or alliance between companies...
- **Pricing Change**: API price adjustment, plan restructuring, or billing model change...
- **Product Launch**: New product, model release, or major feature announcement...
- **Acquisition**: Company acquisition, acqui-hire, or merger...
- **Hiring Surge**: Significant increase in job postings, indicating expansion...
- **Hiring Freeze or Layoff**: Workforce reduction, hiring pause, or restructuring...
- **Regulatory Filing**: SEC filing, compliance document, or regulatory submission...
- **Infrastructure Investment**: Data center build-out, compute expansion, or major capex...
- **Enterprise Contract**: Major enterprise deal, government contract, or large customer win...
- **Open Source Release**: Model weights release, library open-source, or code publication...
- **API Policy Change**: Terms of service update, usage policy change, or API restrictions...
- **Market Entry**: Geographic expansion, new vertical, or market segment entry...
- **Market Exit**: Product sunset, market withdrawal, or service discontinuation...
- **Funding Round**: Venture funding, debt raise, or secondary sale...
- **Executive Change**: C-suite hire, departure, or board change...
...
git checkout ENGINE_v3.0_ACTION

# 3. Install dependencies
pip install -r requirements.txt

# 4. Set experiment
python -c "from utils.experiment_manager import set_active_experiment; set_active_experiment('v3_0_action_test')"
...
*Last updated: 2026-02-10T08:43:25.059660 UTC*
